...
export default class Wave extends Component {
	...
	startAnimation(props) {
		...
		Animated.parallel([
			this.animationCycle(this.state.wavesPosition[0], -50, 0, 4000),
			this.animationCycle(this.state.wavesPosition[1], -60, 0, 4000),
			this.animationCycle(this.state.wavesPosition[2], -40, 0, 4000)
