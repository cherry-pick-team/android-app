...
export default class PlayController extends Component {
	static propTypes = {
		...
		chunkStarted: PropTypes.func.isRequired,
		chunkPaused: PropTypes.func.isRequired,
		chunkLoading: PropTypes.func.isRequired
	};
	...
	render() {
		const {songId, chunkIndex, isActive, onNext, onPrev, duration} = this.props;
