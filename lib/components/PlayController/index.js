	...
	<View>
		<View style={[styles.container, {
			...
			<View style={styles.playButton}>
				<View style={styles.buttonPrev}>
					<RippleIcon type="previous" from="Foundation" size={30} color={isActive ? 'white' : '#9E9E9E'}/>
				</View>
				<PlayButton
					songId={songId}
				...
				<View style={styles.buttonNext}>
					<RippleIcon type="next" from="Foundation" size={30} color={isActive ? 'white' : '#9E9E9E'}/>
				</View>
			</View>
			{isActive &&
				<View style={styles.shareButton}>
					<RippleIcon type="share" from="FontAwesome" size={27} color={'white'}/>
				</View>
			}
		</View>
		<View style={styles.sliderContainer}>
			<Slider
				...
				minimumTrackTintColor={isActive ? '#f44336' : '#E0E0E0'}
				maximumTrackTintColor="#FFFAFF"
				thumbTintColor={isActive ? '#f44336' : '#9E9E9E'}
			/>
		</View>
	</View>
);
