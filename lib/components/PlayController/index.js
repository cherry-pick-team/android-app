 ...
 */
const PlayController = ({songId, chunkIndex, duration, isActive, onNext, onPrev}) => (
	<View>
		<View style={[styles.container, {
			...
			<View style={styles.playButton}>
				<TouchableNativeFeedback onPress={isActive ? onPrev : null}>
					<View style={[styles.buttonPrev, {backgroundColor: isActive ? primaryColor : 'white'}]}>
						<Icon
							type="previous"
							from="Foundation"
							size={30}
				...
				<TouchableNativeFeedback onPress={isActive ? onNext : null}>
					<View style={[styles.buttonNext, {backgroundColor: isActive ? primaryColor : 'white'}]}>
						<Icon
							type="next"
							from="Foundation"
							size={30}
