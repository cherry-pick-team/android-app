...
export default class PlayController extends Component {
	...
	componentWillReceiveProps(nextProps) {
		if (this.state.isPlaying
				&& nextProps.playingSongId !== this.props.songId + this.props.from) {
			this.stop();
		}
	}
	...
	play() {
		...
		this.props.play(this.props.songId + this.props.from);
	}
			...
			<View>
				<View style={[styles.container, {
					...
					<View style={styles.playButton}>
						<TouchableNativeFeedback onPress={isActive ? this.handlePrev.bind(this) : null}>
						...
						/>
						<TouchableNativeFeedback onPress={isActive ? this.handleNext.bind(this) : null}>
